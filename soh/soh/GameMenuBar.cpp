...
namespace GameMenuBar {
    ...
    void Draw() {
        ...
        if (ImGui::BeginMenu("Randomizer"))
        {
            ...
            ImGui::Dummy(ImVec2(0.0f, 0.0f));
            if (ImGui::Button(GetWindowButtonText("Check Tracker", CVar_GetS32("gCheckTrackerEnabled", 0)).c_str(),
                              buttonSize)) {
            ...
            ImGui::Dummy(ImVec2(0.0f, 0.0f));
            if (ImGui::Button(
                    GetWindowButtonText("Check Tracker Settings", CVar_GetS32("gCheckTrackerSettingsEnabled", 0)).c_str(),
                    buttonSize)) {
